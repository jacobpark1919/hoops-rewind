    ...
    <div className="min-h-screen bg-background text-foreground px-4 py-8 max-w-2xl mx-auto">
      ...
      <div className="space-y-4 text-sm text-muted-foreground leading-relaxed">
        ...
        <p className="flex items-center gap-2">
          ...
          <a href="mailto:sportsrewind123@gmail.com" className="text-primary hover:underline">
        ...
        <ul className="list-disc pl-5 space-y-1">
          <li>Check our <Link to="/privacy" className="text-primary hover:underline">Privacy Policy</Link> and <Link to="/terms" className="text-primary hover:underline">Terms of Service</Link> for common questions.</li>
